...
class VinylFlooringScreen extends StatefulWidget {
  const VinylFlooringScreen({super.key});

  @override
  State<VinylFlooringScreen> createState() => _VinylFlooringScreenState();
}

class _VinylFlooringScreenState extends State<VinylFlooringScreen> {
  ...
  void initializeWebView() {
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/vinyl-flooring-in-bangladesh/'));
  }
