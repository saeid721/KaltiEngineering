...
class EtpProtectiveCoatingScreen extends StatefulWidget {
  const EtpProtectiveCoatingScreen({super.key});

  @override
  State<EtpProtectiveCoatingScreen> createState() => _EtpProtectiveCoatingScreenState();
}

class _EtpProtectiveCoatingScreenState extends State<EtpProtectiveCoatingScreen> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/etp-protective-coating-in-bangladesh/'));
  }
