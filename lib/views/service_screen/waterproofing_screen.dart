...
class WaterproofingScreen extends StatefulWidget {
  const WaterproofingScreen({super.key});

  @override
  State<WaterproofingScreen> createState() => _WaterproofingScreenState();
}

class _WaterproofingScreenState extends State<WaterproofingScreen> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/waterproofing-in-bangladesh/'));
  }
