...
class FloorHardenerScreen extends StatefulWidget {
  const FloorHardenerScreen({super.key});

  @override
  State<FloorHardenerScreen> createState() => _FloorHardenerScreenState();
}

class _FloorHardenerScreenState extends State<FloorHardenerScreen> {
  ...
  void initializeWebView() {
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/floor-hardener-in-bangladesh/'));
  }
