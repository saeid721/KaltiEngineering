...
class FairFacePlasterScreen extends StatefulWidget {
  const FairFacePlasterScreen({super.key});

  @override
  State<FairFacePlasterScreen> createState() => _FairFacePlasterScreenState();
}

class _FairFacePlasterScreenState extends State<FairFacePlasterScreen> {
  ...
  void initializeWebView() {
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/fair-face-plaster-in-bangladesh/'));
  }
