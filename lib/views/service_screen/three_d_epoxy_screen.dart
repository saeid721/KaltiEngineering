...
class ThreeDEpoxyFlooringScreen extends StatefulWidget {
  const ThreeDEpoxyFlooringScreen({super.key});

  @override
  State<ThreeDEpoxyFlooringScreen> createState() => _ThreeDEpoxyFlooringScreenState();
}

class _ThreeDEpoxyFlooringScreenState extends State<ThreeDEpoxyFlooringScreen> {
  ...
  void initState() {
    ...
    controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://kaltiengineering.com/3d-epoxy-flooring-in-bangladesh/'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const PreferredSize(
        ...
        child: GlobalAppBar(
          title: '3D Epoxy Flooring Solution',
        ),
      ),
